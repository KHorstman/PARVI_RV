...
if __name__ == "__main__":
    ...
    # rv_list = np.linspace(-55.567,30,1,endpoint=True)
    ...
    if not plotonly:
        ...
        #         fib = np.nanargmax(np.nanmean(science_spec,axis=(1,2)))
            ...
            if "gg_Tau" in sciencedir or "HIP_12787" in sciencedir or ("DH_Tau" in sciencedir and not ("DH_Tau_B" in sciencedir)):
            ...
            if "ROXs_12B" in sciencedir or "DH_Tau_B" in sciencedir or "2M0746" in sciencedir:
